...
from .subway import get_subway_arrivals, get_train_arrivals_at_station

# Register all tools - add new tools here
tools = [get_weather, get_polymarket_opportunities, get_arxiv_articles, get_latest_photos, post_tweet, get_linear_issues, get_mercury_balance, get_subway_arrivals, get_train_arrivals_at_station]
