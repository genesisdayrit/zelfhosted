...
tools = [get_weather, get_polymarket_opportunities, get_arxiv_articles, get_latest_photos, post_tweet, get_linear_issues, get_mercury_balance, get_subway_arrivals, get_train_arrivals_at_station, get_nearby_subway_stations, get_nearby_subway_arrivals, search_youtube_song]
